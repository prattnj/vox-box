...
from util.layers import TacotronSTFT
import torch
import os
from util import text_to_sequence
from util.methods import load_wav_to_torch

class VocalData(Dataset):

  def __init__(self, metadata_file, hparams):
    head, _ = os.path.split(metadata_file)
    self.dir = head
    with open(metadata_file, 'r') as file:
      self.audiopaths_and_text = [line.strip().split('|') for line in file]
